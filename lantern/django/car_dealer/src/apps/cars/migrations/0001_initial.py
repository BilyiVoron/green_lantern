    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_registration_date', models.DateField(default=datetime.date.today, verbose_name='First registration date')),
                ('engine_type', models.CharField(blank=True, max_length=25)),
                ('engine_power', models.IntegerField(null=True)),
                ('fuel_type', models.CharField(max_length=25, null=True)),
                ('fuel_capacity', models.IntegerField(null=True)),
                ('gear_box', models.CharField(choices=[('automatic transmission', 'automatic transmission'), ('semi-automatic transmission', 'semi-automatic transmission'), ('manual transmission', 'manual transmission')], max_length=27, null=True)),
                ('all_wheel_drive', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True)),
                ...
                ('population_type', models.CharField(max_length=55, null=True)),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=9, null=True)),
            ],
            options={
                'verbose_name': 'Car',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ManyToManyField(related_name='properties', to='cars.Car')),
            ],
        ),
        migrations.AddIndex(
            model_name='color',
